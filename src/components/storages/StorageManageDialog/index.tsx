				...
				<Container className={classes.container}>
						...
						<Grid container spacing={1}>
							<Grid item xs={12} md={6}>
								...
								<TextField
									...
									rows={10}
									value={
										'게시판의 관리자는 불필요한 개인정보를 수집하거나 처리하지 않도록 하며, 관련 법령 및 약관을 준수합니다.\n'
										+ '\n'
										+ '1. 부정한 목적으로의 개인정보 처리 금지\n\n'
										+ '금전적 이득 등을 위하여 부정한 목적으로 개인정보를 수집하거나 매매 등을 이용한 우회적인 개인정보 부정 판매 등이 적발될 경우, 개념글 저장소는 관련 법령과 사이트 이용약관 및 게시판 운영원칙 등에 따라 해당 게시판에 대한 제재, 그리고 관련 법령에 따른 민형사상의 책임을 물을 수 있습니다.\n\n'
										...
										+ '그 밖에 위에 기재하지 않은 사항은 개념글 저장소 개인정보처리방침, 이용약관, 게시판 서비스 운영원칙 등에서 정한 바에 의합니다.'
									}
									disabled
								/>
							</Grid>
							<Grid item xs={12} md={6}>
								...
								<TextField
									...
									rows={10}
									value={
										'게시판 서비스는 이용자분들이 직접 만들고 운영하는 커뮤니티 공간으로 모든 이용자들은 아래 운영원칙을 준수해야 합니다.\n\n'
										+ '[모든 이용자가 지켜야 하는 원칙]\n\n'
										+ '모든 이용자는 게시판 주제에 맞는 정상적인 활동을 해주셔야 합니다.\n\n'
										+ '게시판 서비스에 등록하는 모든 콘텐츠의 저작권은 게시한 이용자 본인에게 있으며, 이로 인해 발생되는 문제에 대해서도 해당 게시물을 게시한 이용자에게 책임이 있습니다.\n'
										+ '모든 이용자는 이용약관 및 운영원칙을 준수해야 하며, 이를 지키지 않아 발생하는 문제에 대해 일체의 책임을 져야 합니다.\n\n'
										+ '[관리자가 지켜야 하는 원칙]\n\n'
										+ '\'관리자\'란 게시판의 운영 권한을 갖는 이용자를 가리키는 단어입니다.\n\n'
										+ '관리자는 게시판을 최초 개설하였거나, 이전 관리자로부터 게시판 위임받은 이용자로서 해당 게시판을 대표하며, 게시판을 관리할 수 있는 모든 권한과 책임을 갖고 있습니다.\n'
										...
										+ '관리자는 게시판이 원활히 운영될 수 있도록 주기적으로 게시판에 방문해 성실하고 공정한 관리를 다해야 합니다. 만약, 장기간(최소 10일 이상) 부재 시 다른 이용자에게 관리자의 책임과 권한이 이관될 수 있습니다.\n'
										+ '부관리자는 관리자가 임명하고 이를 수락한 이용자로 게시판을 관리할 수 있는 일부 권한과 책임이 있습니다.\n\n'
										+ '[이용제한 사유에 해당하는 금지 활동]\n\n'
										+ '1. 음란물 유포\n\n'
										...
										+ '상업적 목적으로 게시판을 운영하거나 게시물을 등록하는 행위\n\n'
										+ '5. 명예훼손 행위\n\n'
										...
										+ '7. 불법적 거래 행위\n\n'
										+ '타인에게 금전적 거래로 게시판을 양도, 대여하거나 그에 준하는 행위\n'
										+ '타인을 기망하여 게시판을 위임받거나 탈취하는 행위\n\n'
										+ '8. 기타 금지 행위\n\n'
										+ '게시판의 주제와 동떨어진 내용과 상식에 어긋나는 내용으로 지속적으로 분란을 야기하는 경우\n'
										+ '특정 단어, 문구를 반복적으로 등록하는 행위\n'
										+ '홍보성 타 사이트 링크 포함 및 광고 게시물\n'
										+ '정상적인 활동으로 볼 수 없는 반복적인 게시판 만들기, 폐쇄, 위임 등의 행위\n'
										+ '개념글 저장소 서비스 운영진을 사칭하는 행위\n\n'
										+ '[이용제한 내용]\n\n'
										+ '1. 게시물 제한\n\n'
										+ '운영원칙에 어긋나는 게시물인 경우 타 이용자가 볼 수 없도록 노출이 제한됩니다.\n\n'
										+ '2. 이용자 이용 정지\n\n'
										+ '운영원칙에 어긋나는 행위를 한 이용자인 경우 게시물/댓글 등록 및 게시판 개설 등의 활동을 할 수 없게 이용이 일시 또는 영구 정지됩니다.\n\n'
										+ '3. 매니저 해임\n\n'
										+ '매니저의 장기간 부재 또는 본 운영원칙에 위반되는 내용의 게시물의 방치 등 불성실한 운영 시 매니저를 해임할 수 있습니다.\n\n'
										+ '4. 게시판 접근 제한\n\n'
										+ '운영원칙에 어긋나는 행위를 방치, 조장했거나 여타의 문제가 있는 경우 다른 이용자가 볼 수 없도록 게시판 접근을 일시 또는 영구적으로 제한합니다.\n\n'
										+ '5. 게시판 폐쇄\n\n'
										+ '중복된 주제의 개설, 개설 시와 무관한 주제로의 무단 변경, 운영원칙에 어긋나는 문제가 반복되거나 심대한 경우, 또는 수사기관의 요청, 불법적인 목적의 운영/개설 의도가 명확한 경우 해당 게시판은 폐쇄 조치됩니다.'
									}
									disabled
								/>
							</Grid>
					...
					<Box mt={1}>
						<FormControlLabel
							...
							label={'게시판 개인정보보호정책 및 운영원칙에 동의합니다.'}
						/>
					</Box>
